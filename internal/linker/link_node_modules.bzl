...
def write_node_modules_manifest(ctx, extra_data = []):
    ...
    # Look through extra_data to find node_modules_root
    ...
    print('node_modules_root is %s' % node_modules_root)
    print('mappings is %s' % mappings)
    print('workspace is %s' % ctx.workspace_name)
    print('bin is %s' % ctx.bin_dir.path)
    content = {
